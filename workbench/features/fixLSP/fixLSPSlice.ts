import { PayloadAction, createAsyncThunk, createSlice } from 'vs/workbench/libraries/vs/workbench/libraries/@reduxjs/toolkit'
import { FixLSPState, FullState, LineChange } from 'vs/workbench/features/window/state'

import { API_ROOT } from 'vs/workbench/utils'

import { getPathForFileId } from 'vs/workbench/features/window/fileUtils'
import { globalViews } from 'vs/workbench/components/globalViews'
import {
    applyLineChangesToView,
    getFixLSPBlobForServerWithSideEffects,
} from 'vs/workbench/features/linter/fixLSPExtension'
