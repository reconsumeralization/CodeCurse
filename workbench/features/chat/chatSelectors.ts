...
export const getIsCommandBarOpen = (state: FullState) => state.chatState.isCommandBarOpen;

export const getCurrentDraftMessage = (state: FullState) => state.chatState.draftMessages[state.chatState.currentConversationId];

export const getLastBotMessage = (state: FullState) => getLastBotMessageMain(state.chatState);

export const getLastBotMessageById = (conversationId: string) => (state: FullState) => getLastBotMessageMain(state.chatState, conversationId);
...
export const getMessages = (conversationId: string) => createSelector(
    (state: FullState) => state.chatState.botMessages.filter((m) => m.conversationId === conversationId),
    (state: FullState) => state.chatState.userMessages.filter((m) => m.conversationId === conversationId),
...
export const getConversationPrompts = (conversationIds: string[], order: "forward" | "reverse" = "forward") => createSelector(
    ...conversationIds.map(getMessages),
    (...messageLists: Message[][]) => messageLists.reduce((acc, messages) => {
...
export const isChatHistoryOpen = createSelector(
  ...
  (chatIsOpen, isChatHistoryOpen) => chatIsOpen && isChatHistoryOpen,
);
...
export const getUserMessages = (state: FullState) => state.chatState.userMessages;
...
export const getFireCommandK = (state: FullState) => state.chatState.fireCommandK;
