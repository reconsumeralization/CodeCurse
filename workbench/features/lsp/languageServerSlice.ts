import { PayloadAction, createAsyncThunk, createSlice } from 'vs/workbench/libraries/@reduxjs/toolkit'
import { getLanguageFromFilename } from '../extensions/utils'
import { LSLanguages, LanguageServerClient } from './stdioClient'
import { Text } from 'vs/workbench/libraries/@codemirror/state'

import { offsetToPos } from './lspPlugin'
import { getContentsIfNeeded, loadFileIfNeeded } from '../window/fileUtils'
import { FullState, LanguageServerState } from 'vs/workbench/features/window/state'
